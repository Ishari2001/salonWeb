...
// Services data
const services = [
  { name: "Hair Cut", price: "Rs.1000 up", duration: "1 hr", img: "destin-hair-studio_salon-images-15_uploaded-03-28-2018.jpg" },
  { name: "Hair Coloring", price: "Rs.3500 up", duration: "2 hrs", img: "71scRiETMiL._AC_UF894,1000_QL80_.jpg" },
  { name: "Pedicure", price: "Rs.8000", duration: "1.5 hrs", img: "istockphoto-1384893122-612x612.jpg" },
  { name: "Facial", price: "Rs.2500", duration: "1 hr", img: "facials.png" },
  { name: "Manicure", price: "Rs.1200", duration: "1 hr", img: "1657021335083.jpg" },
  { name: "Hair Spa", price: "Rs.3000", duration: "1.5 hrs", img: "images-hairspa.jpg" },
];
  ...
  return (
    <div className="min-h-screen w-full bg-blue-50 py-12 px-4 md:px-20">
      ...
      <div className="text-center mb-12">
        <label className="mr-4 font-semibold text-blue-700 text-lg">
          Select Date:
        </label>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
        {services.map((service) => {
          ...
          return (
            <div key={service.name} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition">

              <img src={service.img} className="w-full h-64 object-cover rounded-lg mb-4" />
              ...
              {Object.keys(counts).length > 0 ? (
                  ...
                  <div className="flex flex-col gap-2">
                    {Object.entries(counts).map(([time, count]) => {
                      ...
                      return (
                        <div
                          key={time}
                          className={`flex justify-between px-3 py-1 rounded font-medium
                            ${isPastTime
                        ...
                        >
                          <span>{time}</span>
                          <span>
                            {count} booked / {seatLimit}{" "}
                            {isPastTime ? "(Past)" : available ? "(Available)" : "(Full)"}
                          </span>
                        </div>
                      );
                    })}
                ...
                <p className="mt-4 text-gray-500">
                  No bookings for this service on {selectedDate}.
                </p>
              )}
            </div>
          );
